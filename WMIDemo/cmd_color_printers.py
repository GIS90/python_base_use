...
def printWhiteBlack_2(mess):
    ...
    resetColor()
#绿底蓝字
def printGreenBlue(mess):
    resetColor()
    set_cmd_text_color(BACKGROUND_GREEN | FOREGROUND_BLUE)
    sys.stdout.write(mess)
    resetColor()
#白底红字
def printWhiteRed(mess):
    resetColor()
    set_cmd_text_color(BACKGROUND_WHITE | FOREGROUND_RED)
    sys.stdout.write(mess)
    resetColor()
#白底红字
def printWhiteBlue(mess):
...
def printYellowBlue(mess):
    set_cmd_text_color(BACKGROUND_YELLOW | FOREGROUND_BLUE)
    sys.stdout.write(mess)
    resetColor()
def printPinkBlue(mess):
    set_cmd_text_color(BACKGROUND_PINK | FOREGROUND_BLUE)
    sys.stdout.write(mess)
    resetColor()
def printYellowRed(mess):
    ...
    resetColor()
#红底黑字
def printRedBlack(mess):
    set_cmd_text_color(BACKGROUND_RED | FOREGROUND_BLACK)
    sys.stdout.write(mess)
    resetColor()
def printRedBlue(mess):
    set_cmd_text_color(BACKGROUND_RED | FOREGROUND_BLUE)
    sys.stdout.write(mess)
    resetColor()
def printRedGreen(mess):
    set_cmd_text_color(BACKGROUND_RED | FOREGROUND_GREEN)
    sys.stdout.write(mess)
    resetColor()
#黑底skyblue字
def printBlackSkyBlue(mess):
    set_cmd_text_color(BACKGROUND_BLACK | FOREGROUND_SKYBLUE)
    sys.stdout.write(mess)
    resetColor()
##############################################################
