            ...
            if self.handshake is False:
                ...
                if self.length_buffer - g_header_length < g_code_length:
                    ...
                    if self.buffer_utf8 == 'quit':
                        ...
                        objectid = self.buffer_utf8
                        if objectid:
                            objectid = objectid.split(',')
                            rlt, message = ShpGeoJsonToJson(objectid, path, fields)
                            print message
                            if rlt:
                        ...
                        # elif self.buffer_utf8 == '5':
                        #     js = os.path.join(cur_dir, 'linkgeo_5_esri.js')
