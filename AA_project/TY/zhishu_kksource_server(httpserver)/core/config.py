...
demo:
    ...
    get kakou stored folder information:
        kakou_folder = get_kakou_folder_config()
    get database kakou table information:
...
def get_kakou_folder_config():
    """
    get kakou stored folder
    :return: kakou folder
    """
    return _config_info["KakouFolder"]


def get_kakou_table_config():
    """
    get database kakou table
    :return: kakou table
    """
